...
int write_t(int inode_number, int offset, void *buf, int count){        
    ...
    printf("=====================\n");
    ssize_t ret; // get bytes of read/write
    ...
    int inode_offset = INODE_OFFSET + (INODE_OFFSET * inode_number); // get offset of inode
    ...
    sb.next_available_inode = inode_offset + BLOCK_SIZE;
    sb.next_available_blk = offset + BLOCK_SIZE;
